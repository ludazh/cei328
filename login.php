...
<html>
	...
	<body id='login-body' class="bg-light">
        ...
        <div class="card col-md-6 offset-md-3 text-center ">
            <h3 class="he3-responsive text-black">Welcome!!</h3>
        </div>
            ...
            <div class="card-body">
                     <form id="login-frm">
                        <div class="form-group">
                            ...
                            <input type="username" name="username" class="form-control" placeholder = "enteryourusername">
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" name="password" class="form-control" placeholder = "enteryourpasss">
                        </div> 
