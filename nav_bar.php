			...
			<div class = "container-fluid">
				<div class = "navbar-header">
					<p class = "navbar-text pull-right text-black"><h3>Quazability</h3></p>
				</div>
		...
		<?php endif; ?>
			...
			<div id="sidebar-field">
				...
				<div id="sidebar-field">
				<a href="myfilemgr/index.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-list"> </i></div>  upload 
				</a>
			</div>
			<div id="sidebar-field">
